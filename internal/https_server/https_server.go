...
func init() {
	...
	// ===== 监控指标 =====
	GE.GET("/metrics", v1.GetMetrics)

	// ===== AI相关API =====
	GE.GET("/ai/status", v1.GetAIStatus)
	GE.GET("/ai/userInfo", v1.GetAIUserInfo)
	GE.POST("/ai/clearContext", v1.ClearAIContext)
	GE.GET("/ai/contextInfo", v1.GetAIContextInfo)
